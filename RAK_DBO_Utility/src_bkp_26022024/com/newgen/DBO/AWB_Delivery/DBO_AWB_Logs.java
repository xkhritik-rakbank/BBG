...
public class DBO_AWB_Logs {

	private static String loggerName = "DBO_AWBLogger";
    protected static org.apache.log4j.Logger DBO_AWBLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DBO_AWBLogger_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DBO_AWBLogger_Logs/"+logDateFormat.format(date)+"/DBO_AWBLogger_log.xml";
