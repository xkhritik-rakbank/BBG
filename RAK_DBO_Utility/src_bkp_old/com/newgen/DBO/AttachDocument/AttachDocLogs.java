...
public final class AttachDocLogs {
	


	
	private static String loggerName = "DBO_AttachDocLogger";
    protected static org.apache.log4j.Logger DBO_AttachDocLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DBOAttachDoc_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DBO_AttachDoc_Logs/"+logDateFormat.format(date)+"/DBO_AttachDoc_log.xml";
