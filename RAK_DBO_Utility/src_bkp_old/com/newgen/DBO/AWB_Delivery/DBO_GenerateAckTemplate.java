...
public class DBO_GenerateAckTemplate 
{
	...
	throws IOException, Exception {
		...
		try {	
			if (!"".equalsIgnoreCase(pdfName) && pdfName != null)
			{
				...
				{
					XMLMap.put("AuthorityToSign", "Shareholder & Authorized Signatory");
				}
				...
				Output = CreatePDF(pdfName, templateSrcPath, templateDestPath, RelatedPartyData.get("AWBNumber"), XMLMap, processInstanceID,RelatedPartyData.get("RelatedPartyID")); // Work -> Generated PDF Path
	...
	public String CreatePDF(String Template_Filename, String templateSrcPath, String templateDestPath, String AwbNo, Map<String, String> XMLMap, String processInstanceID,String RPID) 
	{
		String finalPdfPath = "";
        try {
