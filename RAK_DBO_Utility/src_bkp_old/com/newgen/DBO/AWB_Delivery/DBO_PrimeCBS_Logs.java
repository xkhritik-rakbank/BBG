...
public final class DBO_PrimeCBS_Logs {

	private static String loggerName = "DBO_PrimeCBSLogger";
    protected static org.apache.log4j.Logger DBO_PrimeCBSLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DBO_PrimeCBSLogger_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DBO_PrimeCBSLogger_Logs/"+logDateFormat.format(date)+"/DBO_PrimeCBSLogger_log.xml";
