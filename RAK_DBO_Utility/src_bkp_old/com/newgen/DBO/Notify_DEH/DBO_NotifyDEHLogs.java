...
public class DBO_NotifyDEHLogs {

	private static String loggerName = "DBO_NotifyLogger";
    protected static org.apache.log4j.Logger DBO_NotifyLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DBO_NotifyLogger_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DBO_NotifyLogger_Logs/"+logDateFormat.format(date)+"/DBO_NotifyLogger_log.xml";
