...
public class DBO_SignCrop_Logs {

	private static String loggerName = "DBO_SignCropLogger";
    protected static org.apache.log4j.Logger DBO_SignCropLogger = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DBO_SignCropLogger.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DBO_SignCrop_Logs/"+logDateFormat.format(date)+"/DBO_SignCrop_log.xml";
