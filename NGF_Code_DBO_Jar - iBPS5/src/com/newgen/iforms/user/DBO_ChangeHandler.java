...
public class DBO_ChangeHandler extends DBOCommon {
	...
	public String onChange(IFormReference iformObj, String control, String stringdata) {
		...
		DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", Inside onChange method of DBO_ChangeHandler with control id-- ");
		try {
			
			if("OnPersonaValChange".equalsIgnoreCase(control))
			{
				DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of Persona inside change event " + Persona);
			...
			else if("SetMainCategoryCustMsg".equalsIgnoreCase(control))
			{
	 			try {
	 				...
	 				DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", Query--" + query);
	 				List<List<String>> lstValue = iformObj.getDataFromDB(query);
	 				DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", Result  ..." + lstValue);
	 				List<String> arr1 = (List) lstValue.get(0);
	 				String mainCategory = arr1.get(0);
	 				String customerMessage = arr1.get(1);
	 				DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of mainCategory before add: "+mainCategory);
	 				DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of customerMessage before add: "+customerMessage);
	 				...
	 				DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of mainCategory after add: "+mainCategory);
	 				DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of customerMessage after add: "+customerMessage);
	 				} catch (Exception e) {
	 				DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control
			...
			else if("getCompanyCategoryValuesonLoad".equalsIgnoreCase(control))
			{
	 			...
	 			try {
	 				...
	 				DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value ccValOnLoad on load  ..." + ccValOnLoad);
	 				DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", to get cc values to insert in cc dropdown start ...");
	 				...
	 				DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", Result  ..." + lstValues);
	 				...
	 				for (int i = 0; i < lstValues.size(); i++) {
	 					...
	 					DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+",Item to add in CompanyCategory combo  ..." + arr1);
	 					...
	 					if(!"".equalsIgnoreCase(ccValOnLoad) && valueCode.equalsIgnoreCase(ccValOnLoad)){
	 						DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value ccValOnLoad on load  ..." + ccValOnLoad);
	 						DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value valueDesc on load  ..." + valueDesc);
	 						DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value valueCode on load  ..." + valueCode);
			...
			else if("Emirates_onTLIAChange".equalsIgnoreCase(control))
			{
				 String TL_status = "";
	 			try {
	 				DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", to insert TL_IA Emirates in dropdown start ...");
	 				String TL_IA = (String) iformObj.getValue("TLIssuingAuthority");
	 				DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of  TL_IA ..." +TL_IA);
	 				...
	 				DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", Query--" + query1);
	 				List<List<String>> lstValues1 = iformObj.getDataFromDB(query1);
	 				DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", Result  ..." + lstValues1);
	 				...
	 				for (int i = 0; i < lstValues1.size(); i++) {
	 					...
	 					DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", Item to add in TL_IA Emirates combo  ..." + arr1);
	 					iformObj.addItemInCombo("TLIssusingAuthorithyEmirate", valueDesc1, valueCode1 , valueDesc1);
	 					if(lstValues1.size() == 1){
	 						DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value valueDesc on load  ..." + valueDesc1);
	 						DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value valueCode on load  ..." + valueCode1);
			...
			{
				DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of Q_USR_0_DBO_RelatedPartyGrid_Title inside change event " + Q_USR_0_DBO_RelatedPartyGrid_Title);
				if(Q_USR_0_DBO_RelatedPartyGrid_Title.equalsIgnoreCase("Mrs") || Q_USR_0_DBO_RelatedPartyGrid_Title.equalsIgnoreCase("Ms")){
					DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of Q_USR_0_DBO_RelatedPartyGrid_Title inside if " + Q_USR_0_DBO_RelatedPartyGrid_Title);
					iformObj.setValue("Q_USR_0_DBO_RelatedPartyGrid_Gender", "F");
				}else if(Q_USR_0_DBO_RelatedPartyGrid_Title.equalsIgnoreCase("Mr")) {
					DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of Q_USR_0_DBO_RelatedPartyGrid_Title inside else " + Q_USR_0_DBO_RelatedPartyGrid_Title);
			...
			else if("DECISION".equalsIgnoreCase(control))
			{
				...
				DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", Query--" + QueryIC_GR);
				...
				DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", gridRowCount " + gridRowCount_InterClrsGR);
				...
				if (actName.equalsIgnoreCase("STP_Operator")) 
				{
					...
					// To populate DECISIONDescription ...
						try {
							DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", To populate DECISIONs Description in  drop down  ...");
							...
							DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", Result  ..." + lstDecisions);
					...
					if(decision.equalsIgnoreCase("Additional Information Required from Customer")){
						...
						iformObj.setStyle("ChannelReferral", "mandatory", "false");
						iformObj.setStyle("Package", "mandatory", "false");
						iformObj.setStyle("InterestRequested", "mandatory", "false");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_CountryofBirth", "mandatory", "false");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_PlaceofBirth", "mandatory", "false");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_MaritalStatus", "mandatory", "false");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_PassportIssueDate", "mandatory", "false");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_EMIDIssueDate", "mandatory", "false");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_CustomerSourcedBy", "mandatory", "false");
						...
						iformObj.setStyle("AssignToGroup", "visible", "true");
						iformObj.setStyle("AssignToGroup", "mandatory", "true");
						iformObj.setStyle("InternalClarification", "visible", "true");
						if(gridRowCount_DeclineGR != 0){
							iformObj.setStyle("DECLINE_REASON_SECTION", "visible", "true");
						}else{
						...
						//ToDo
						String ManualSOF1 = (String) iformObj.getValue("Q_USR_0_DBO_RelatedPartyGrid_ManualUploadSOF");
						if(ManualSOF1.equalsIgnoreCase("Y") || ManualSOF1.equalsIgnoreCase("Yes"))
						{
						...
						DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of IsChqBkReq inside change event " + IsChqBkReq);
						if(IsChqBkReq.equalsIgnoreCase("Y")){
							DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of IsChqBkReq inside if " + IsChqBkReq);
							iformObj.setStyle("NameOnChqBk", "mandatory", "true");
						}else {
							DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of IsChqBkReq inside else " + IsChqBkReq);
							iformObj.setStyle("NameOnChqBk", "mandatory", "false");
						}
						DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of Q_USR_0_DBO_RelatedPartyGrid_DebitCardReq inside change event " + Q_USR_0_DBO_RelatedPartyGrid_DebitCardReq);
						if(Q_USR_0_DBO_RelatedPartyGrid_DebitCardReq.equalsIgnoreCase("Y")){
							DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of Q_USR_0_DBO_RelatedPartyGrid_DebitCardReq inside if " + Q_USR_0_DBO_RelatedPartyGrid_DebitCardReq);
							iformObj.setStyle("Q_USR_0_DBO_RelatedPartyGrid_Name_On_Debit_Card", "mandatory", "true");
						}else{
							DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", value of Q_USR_0_DBO_RelatedPartyGrid_DebitCardReq inside else " + Q_USR_0_DBO_RelatedPartyGrid_DebitCardReq);
							iformObj.setStyle("Q_USR_0_DBO_RelatedPartyGrid_Name_On_Debit_Card", "mandatory", "false");
						}
						iformObj.setStyle("CompanyPEP", "mandatory", "false");
						iformObj.setStyle("Q_USR_0_DBO_RelatedPartyGrid_PEP", "mandatory", "false");
					...
					else if(decision.equalsIgnoreCase("") || decision.equalsIgnoreCase("Select")){ // when changed to blank then all should become optional
						iformObj.setStyle("DECISION", "mandatory", "false");
						iformObj.setStyle("TLNumber", "mandatory", "false");
						iformObj.setStyle("TradeName", "mandatory", "false");
						iformObj.setStyle("TLIssuingAuthority", "mandatory", "false");
						iformObj.setStyle("TLIssusingAuthorithyEmirate", "mandatory", "false");
					...
					else{ // remaining 4 decisions which are leading to fulfillment
						if(gridRowCount_InfoGR != 0){
							iformObj.setStyle("AdditionalInfoRequired", "visible", "true");
						}else{
							iformObj.setStyle("AdditionalInfoRequired", "visible", "false");
						...
						iformObj.setStyle("ChannelReferral", "mandatory", "true");
						iformObj.setStyle("Package", "mandatory", "true");
						iformObj.setStyle("InterestRequested", "mandatory", "true");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_CountryofBirth", "mandatory", "true");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_PlaceofBirth", "mandatory", "true");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_MaritalStatus", "mandatory", "true");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_PassportIssueDate", "mandatory", "true");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_EMIDIssueDate", "mandatory", "true");
						iformObj.setStyle("Q_RB_DBO_TXNTABLE_CustomerSourcedBy", "mandatory", "true");
					}
			...
			else if("TLIssuingAuthority".equalsIgnoreCase(control))
            {
                  ...
                  DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", outputXML AP Procedure XML Entry "+sOutputXML);
                  
                  if(sOutputXML.indexOf("<MainCode>0</MainCode>")>-1)
                  {
                    DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", WFChangeWorkItemPriority Successful ");
                    ...
                    {
                    	DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", GetWorkItem failed ");
                        return "Error";
                    }
                  }
                  else
                  {
                        DBO.mLogger.info("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", WFChangeWorkItemPriority failed ");
                        return "Error";
                  }
            }
			...
			DBO.mLogger.debug("WINAME: "+WI_Name+", WSNAME: "+actName+", ControlName: "+control+", Exception 2 - " + exc);
		}
