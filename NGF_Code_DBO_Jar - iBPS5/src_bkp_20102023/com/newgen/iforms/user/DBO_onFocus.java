...
public class DBO_onFocus extends DBOCommon {
	...
	public String onFocus(IFormReference iformObj, String control, String stringdata) {
		...
		try {
			...
			DBO.mLogger.debug("value of control inside change event" + iformObj.getValue("q_Assign_to_Group"));
			
			if("q_Assign_to_Group".equalsIgnoreCase(control))
			{
				...
				if(!groupName.contains("_Controls")){
					...
					iformObj.removeItemFromCombo("q_Assign_to_Group", 4);
