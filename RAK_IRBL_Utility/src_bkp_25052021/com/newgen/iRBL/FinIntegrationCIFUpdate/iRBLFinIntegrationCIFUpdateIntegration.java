...
public class iRBLFinIntegrationCIFUpdateIntegration
{
			...
			HashMap<String, String> socketDetailsMap, HashMap<String, String> ExtTabDataMap)
	{
		...
		try
		{
			...
			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Integration input XML: "+sInputXML);
			...
			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("responseXML: "+responseXML);
		    ...
		    iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Return Code: "+return_code);
		    ...
		    iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Return Desc: "+return_desc);
			...
			int connection_timeout, int integrationWaitTime,HashMap<String, String> socketDetailsMap, HashMap<String, String> ExtTabDataMap, StringBuilder sInputXML)
	{
		...
		try
		{
			...
			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("userName "+ username);
			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("SessionId "+ sessionId);
			...
			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("SocketServerPort "+ socketServerPort);
	   		...
	   		if (!("".equalsIgnoreCase(socketServerIP) && socketServerIP == null && socketServerPort==0))
	   		{
    			...
    			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Dout " + dout);
    			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Din " + din);
    			...
    			if (inputRequest != null && inputRequest.length() > 0)
    			{
    				...
    				iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("RequestLen: "+inputRequestLen + "");
    				inputRequest = inputRequestLen + "##8##;" + inputRequest;
    				iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("InputRequest"+"Input Request Bytes : "+ inputRequest.getBytes("UTF-16LE"));
    			...
    			if (num > 0)
    			{
    				...
    				iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("OutputResponse: "+outputResponse);
    		...
    		{
    			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("SocketServerIp and SocketServerPort is not maintained "+"");
    			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("SocketServerIp is not maintained "+	socketServerIP);
    			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug(" SocketServerPort is not maintained "+	socketServerPort);
		...
		{
			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Exception Occured Mq_connection_CC"+e.getStackTrace());
			return "";
		}
		finally
		{
			...
			{
				iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Final Exception Occured Mq_connection_CC"+e.getStackTrace());
				//printException(e);
			}
		}
			...
			String processInstanceID, String ws_name, String userName, StringBuilder sInputXML)
	{
		...
		strBuff.append("</MQ_REQUEST_XML>");
		strBuff.append("</APMQPUTGET_Input>");
		iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("GetRequestXML: "+ strBuff.toString());
			...
			sessionId, String processInstanceID,String message_ID, int integrationWaitTime)
	{
		...
		try
		{
			...
			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Response APSelect InputXML: "+responseInputXML);

			int Loop_count=0;
			do
			{
				String responseOutputXML=CommonMethods.WFNGExecute(responseInputXML,sJtsIp,iJtsPort,1);
				iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Response APSelect OutputXML: "+responseOutputXML);

			    XMLParser xmlParserSocketDetails= new XMLParser(responseOutputXML);
			    String responseMainCode = xmlParserSocketDetails.getValueOf("MainCode");
			    iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("ResponseMainCode: "+responseMainCode);



			    int responseTotalRecords = Integer.parseInt(xmlParserSocketDetails.getValueOf("TotalRetrieved"));
			    iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("ResponseTotalRecords: "+responseTotalRecords);
			    ...
			    if (responseMainCode.equals("0") && responseTotalRecords > 0)
				{
	        		...
	        		//iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("ResponseXMLData: "+responseXMLData);

	        		outputResponseXML=xmlParserResponseXMLData.getValueOf("OUTPUT_XML");
	        		//iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("OutputResponseXML: "+outputResponseXML);
		...
		{
			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Exception occurred in outputResponseXML" + e.getMessage());
			iRBLFinIntegrationCIFUpdateLog.iRBLFinIntegrationCIFUpdateLogger.debug("Exception occurred in outputResponseXML" + e.getStackTrace());
			outputResponseXML="Error";
		}
