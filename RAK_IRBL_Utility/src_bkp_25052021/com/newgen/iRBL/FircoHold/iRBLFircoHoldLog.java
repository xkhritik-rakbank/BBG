...
public final class iRBLFircoHoldLog
{
	private static String loggerName = "iRBLFircoHoldLogger";
    protected static org.apache.log4j.Logger iRBLFircoHoldLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "iRBL_FircoHold_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/iRBL_FircoHold_Logs/"+logDateFormat.format(date)+"/iRBL_FircoHold_Log.xml";
