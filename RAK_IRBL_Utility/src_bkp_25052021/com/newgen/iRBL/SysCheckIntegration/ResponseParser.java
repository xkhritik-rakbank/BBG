                        ...
                        if (sQry.equalsIgnoreCase("") || (mainCode.equalsIgnoreCase("0") && selectdata.equalsIgnoreCase("0") && !stopIndividualToInsert))
                          {
                            ...
                            try
                              ...
                              {
                                iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("Exception occured in commonParseProduct_1: " + e.getMessage());
                                e.printStackTrace();
                              }
                            catch (Exception ex)
                              {
        ...
        try
          {
            if (!parseXml.contains(tagName))
            ...
            else
              {
                ...
                //iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("CustExpose_Output jsp: final value for collection summary: "+retVal);
                return retVal;
              }
