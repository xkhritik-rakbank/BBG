...
public class iRBLIntegration
{
			...
			HashMap<String, String> socketDetailsMap, HashMap<String, String> ExtTabDataMap)
	{
		...
		try
		{
			...
			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Integration input XML: "+sInputXML);
			...
			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("responseXML: "+responseXML);
		    ...
		    iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Return Code: "+return_code);
		    ...
		    iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Return Desc: "+return_desc);
			...
			int connection_timeout, int integrationWaitTime,HashMap<String, String> socketDetailsMap, HashMap<String, String> ExtTabDataMap, StringBuilder sInputXML)
	{
		...
		try
		{
			...
			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("userName "+ username);
			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("SessionId "+ sessionId);
			...
			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("SocketServerPort "+ socketServerPort);
	   		...
	   		if (!("".equalsIgnoreCase(socketServerIP) && socketServerIP == null && socketServerPort==0))
	   		{
    			...
    			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Dout " + dout);
    			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Din " + din);
    			...
    			if (inputRequest != null && inputRequest.length() > 0)
    			{
    				...
    				iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("RequestLen: "+inputRequestLen + "");
    				inputRequest = inputRequestLen + "##8##;" + inputRequest;
    				iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("InputRequest"+"Input Request Bytes : "+ inputRequest.getBytes("UTF-16LE"));
    			...
    			if (num > 0)
    			{
    				...
    				iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("OutputResponse: "+outputResponse);
    		...
    		{
    			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("SocketServerIp and SocketServerPort is not maintained "+"");
    			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("SocketServerIp is not maintained "+	socketServerIP);
    			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug(" SocketServerPort is not maintained "+	socketServerPort);
		...
		{
			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Exception Occured Mq_connection_CC"+e.getStackTrace());
			return "";
		}
		finally
		{
			...
			{
				iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Final Exception Occured Mq_connection_CC"+e.getStackTrace());
				//printException(e);
			}
		}
			...
			String processInstanceID, String ws_name, String userName, StringBuilder sInputXML)
	{
		...
		strBuff.append("</MQ_REQUEST_XML>");
		strBuff.append("</APMQPUTGET_Input>");
		iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("GetRequestXML: "+ strBuff.toString());
			...
			sessionId, String processInstanceID,String message_ID, int integrationWaitTime)
	{
		...
		try
		{
			...
			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Response APSelect InputXML: "+responseInputXML);

			int Loop_count=0;
			do
			{
				String responseOutputXML=CommonMethods.WFNGExecute(responseInputXML,sJtsIp,iJtsPort,1);
				iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Response APSelect OutputXML: "+responseOutputXML);

			    XMLParser xmlParserSocketDetails= new XMLParser(responseOutputXML);
			    String responseMainCode = xmlParserSocketDetails.getValueOf("MainCode");
			    iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("ResponseMainCode: "+responseMainCode);



			    int responseTotalRecords = Integer.parseInt(xmlParserSocketDetails.getValueOf("TotalRetrieved"));
			    iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("ResponseTotalRecords: "+responseTotalRecords);
			    ...
			    if (responseMainCode.equals("0") && responseTotalRecords > 0)
				{
	        		...
	        		//iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("ResponseXMLData: "+responseXMLData);

	        		outputResponseXML=xmlParserResponseXMLData.getValueOf("OUTPUT_XML");
	        		//iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("OutputResponseXML: "+outputResponseXML);
		...
		{
			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Exception occurred in outputResponseXML" + e.getMessage());
			iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Exception occurred in outputResponseXML" + e.getStackTrace());
			outputResponseXML="Error";
		}
