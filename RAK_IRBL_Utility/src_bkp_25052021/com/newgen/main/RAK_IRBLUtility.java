...
import com.newgen.iRBL.FinIntegrationCIFUpdate.iRBLFinIntegrationCIFUpdate;
import com.newgen.iRBL.FircoHold.iRBLFircoHold;
import com.newgen.iRBL.StatusUpdate.iRBLStatusUpdate;
...
public class RAK_IRBLUtility
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			if(mainPropMap.get("IRBL_StatusUpdate")!=null && mainPropMap.get("IRBL_StatusUpdate").equalsIgnoreCase("Y"))
			{
				Thread iRBLStatusUpdateThread = new Thread(new iRBLStatusUpdate());
				iRBLStatusUpdateThread.start();
				System.out.println("IRBL_StatusUpdate Started");
				MainLogger.info("IRBL_StatusUpdate Started");
			}
			...
			if(mainPropMap.get("iRBL_FinIntegrationCIFUpdate")!=null && mainPropMap.get("iRBL_FinIntegrationCIFUpdate").equalsIgnoreCase("Y"))
			{
				Thread iRBLFinIntegrationCIFUpdateThread = new Thread(new iRBLFinIntegrationCIFUpdate());
				iRBLFinIntegrationCIFUpdateThread.start();
				System.out.println("iRBLFinIntegrationCIFUpdate Started");
				MainLogger.info("iRBLFinIntegrationCIFUpdate Started");
			}
