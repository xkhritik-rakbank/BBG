			...
			HashMap<String, String> socketDetailsMap)
	{
		...
		try
		{
			...
			if(xmlParserData.getValueOf("MainCode").equalsIgnoreCase("0")&& iTotalrec>0)
			{
				...
				{		
					CheckGridDataMap.put("CIFType",objWorkList.getVal("CIFType").trim());
					CheckGridDataMap.put("CIFID", objWorkList.getVal("CIFID").trim());
					CheckGridDataMap.put("CustType", objWorkList.getVal("CustType").trim());
					CheckGridDataMap.put("CIFVerificationStatus", objWorkList.getVal("CIFVerificationStatus").trim());
					...
					if( !objWorkList.getVal("CIFVerificationStatus").trim().equalsIgnoreCase("Success") && !objWorkList.getVal("CIFID").trim().equalsIgnoreCase(""))
					{
