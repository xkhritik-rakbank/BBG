                ...
                for (Map.Entry<String, String> entry : map.entrySet())
                  {
                    ...
                    if (sTableName.equalsIgnoreCase("USR_0_iRBL_InternalExpo_CardDetails"))
                      {
                        columnName = valueArr[0] + ",Liability_type,Request_Type,FullNm,CifId,Wi_Name";
                        columnValues = valueArr[1] + ",'" + cust_type + "','" + returnType + "','" + FullNm + "','" + cifId + "','" + wi_name + "'";
                      ...
                      {
                        columnName = valueArr[0] + ",Liability_type,Request_Type,FullNm,Product_Type,CardType,CifId,Wi_Name";
                        columnValues = valueArr[1] + ",'" + cust_type + "','" + returnType + "','" + FullNm + "','" + prod + "','" + subprod + "','" + cifId + "','" + wi_name + "'";
                    ...
                    else if (sTableName.equalsIgnoreCase("USR_0_iRBL_ExternalExpo_CardDetails"))
                      {
                        ...
                        Utilization = Utilization.replace("\n", "").replace("\r", "");
                        columnName = valueArr[0] + ",Liability_type,Request_Type,FullNm,Product_Type,sub_product_type,CifId,Wi_Name";
                        columnValues = valueArr[1] + ",'" + cust_type + "','" + returnType + "','" + FullNm + "','" + prod + "','" + subprod + "','" + cifId + "','" + wi_name + "'";
                        String columnName_arr[] = columnName.split(",");
                        String columnValues_arr[] = columnValues.split(",");
                        for (int arrlen = 0; arrlen < columnName_arr.length; arrlen++)
