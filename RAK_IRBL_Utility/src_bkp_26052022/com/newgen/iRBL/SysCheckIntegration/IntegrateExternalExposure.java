	        ...
	        if ("EXT".equalsIgnoreCase(CheckGridDataMap.get("DATAFROM")))
	          {
	            ...
	            sInputXML = new StringBuilder("<EE_EAI_MESSAGE><EE_EAI_HEADER><MsgFormat>CUSTOMER_EXPOSURE</MsgFormat>"
	              ...
	              + "<LosIndicator>1</LosIndicator><ContractType>1</ContractType><OverridePeriod>1</OverridePeriod>" 
	        ...
	        else
	          {
	            ...
	            sInputXML = new StringBuilder("<EE_EAI_MESSAGE><EE_EAI_HEADER><MsgFormat>CUSTOMER_EXPOSURE</MsgFormat>"
	              ...
	              + "<LosIndicator>1</LosIndicator><ContractType>"+ContractType+"</ContractType><OverridePeriod>1</OverridePeriod>" //Added by suraj-Rachit01032022
	              + "<PrimaryMobileNo>" + mobileNumber
