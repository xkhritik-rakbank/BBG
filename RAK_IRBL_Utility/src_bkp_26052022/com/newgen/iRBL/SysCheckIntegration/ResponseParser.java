...
public class ResponseParser
  {
                ...
                if ("0000".equalsIgnoreCase(returnCode) || ("ExternalExposure".equalsIgnoreCase(returnType) && ("B003".equalsIgnoreCase(returnCode) || "B005".equalsIgnoreCase(returnCode))))
                  {
                    if ("InternalExposure".equalsIgnoreCase(returnType))
                      ...
                      {
                         result_str = parseExternalExposure(returnType, parseXml, wrapperIP, wrapperPort, sessionId, cabinetName, wi_name, prod, subprod, cifId, cust_type, RelatedPartyId);
                      }
                    else if ("CollectionsSummary".equalsIgnoreCase(returnType))
                      {
                        result_str = parseCollectionSummary(returnType, parseXml, wrapperIP, wrapperPort, sessionId, cabinetName, wi_name, prod, subprod, cifId, cust_type, RelatedPartyId);
                      }
                  }
    ...
    public static String parseInternalExposure(String returnType, String parseXml, String wrapperIP, String wrapperPort, String sessionId, String cabinetName, String wi_name,
      String prod, String subprod, String cifId, String cust_type, String RelatedPartyId)
      {
        ...
        iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("Inside parseInternalExposure - cifid request-"+cifId);
        try
          {
            ...
            for (int i = 0; i < nList_loan.getLength(); i++)
              {
                ...
                iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("Inside parseInternalExposure - cifid response-"+cifId);  
        ...
        try
          {
            ...
            flag1 = commonParseProduct(parseXml, tagName, wi_name, returnType, sTableName, wrapperIP, wrapperPort, sessionId, cabinetName, subTagName, prod, subprod, cifId, cust_type, subtag_single, RelatedPartyId);
        ...
        try
          {
            ...
            flag1 = commonParseProduct_collection(parseXml, tagName, wi_name, returnType, sTableName, wrapperIP, wrapperPort, sessionId, cabinetName, subTagName, prod, subprod, cifId,
              subtag_single, cust_type, RelatedPartyId);
            ...
            if (flag1.equalsIgnoreCase("true"))
              {
                ...
                flag1 = commonParseProduct_collection(parseXml, tagName, wi_name, returnType, sTableName, wrapperIP, wrapperPort, sessionId, cabinetName, subTagName, prod, subprod,
                  cifId, subtag_single, cust_type, RelatedPartyId);
                if (flag1.equalsIgnoreCase("true"))
                  {
                    tagName = "Derived";
                    subTagName = "";
                ...
                for (Map.Entry<String, String> entry : map.entrySet())
                  {
                    ...
                    if (sTableName.equalsIgnoreCase("USR_0_iRBL_InternalExpo_CardDetails"))
                    ...
                    else if (sTableName.equalsIgnoreCase("USR_0_iRBL_InternalExpo_Derived"))
                      {
                        ...
                        columnName = valueArr[0] + ",Range,Request_Type,CifId,FullNm,TotalOutstanding,TotalOverdue,NoOfContracts,ReportURL,ReferenceNo,AECB_Score,RelatedPartyId,CBApplicationID,Wi_Name";
                        columnValues = valueArr[1] + ",'" + range + "','" + returnType + "','" + cifId + "','" + FullNm + "','" + TotalOutstanding + "','" + TotalOverdue + "','" + NoOfContracts
                          + "','" + ReportUrl + "','"+ referenceNo + "','" + Aecb_Score + "','" + RelatedPartyId + "','" + CBApplicationID + "','" + wi_name + "'";
    ...
    public static String commonParseProduct_collection(String parseXml, String tagName, String wi_name, String returnType, String sTableName, String wrapperIP, String wrapperPort, String sessionId,
      String cabinetName, String subTagName, String prod, String subprod, String cifId, String subtag_single, String cust_type, String RelatedPartyId)
      {
        String retVal = "";
        try
          {
                ...
                for (Map.Entry<String, String> entry : map.entrySet())
                  {
                    ...
                    if (sTableName.equalsIgnoreCase("USR_0_iRBL_InternalExpo_CardDetails"))
                      ...
                      {
                        columnName = valueArr[0] + ",CifId,Request_Type,Product_Type,CardType,RelatedPartyId,Wi_Name";
                        columnValues = valueArr[1] + ",'" + cifId + "','" + returnType + "','" + prod + "','" + subprod + "','" + RelatedPartyId + "','" + wi_name + "'";
                    ...
                    else if (sTableName.equalsIgnoreCase("USR_0_iRBL_InternalExpo_AcctDetails"))
                      {
                        ...
                        //PCASP-2833 
                        //String isDirect = (parseXml.contains("<IsDirect>")) ? parseXml.substring(parseXml.indexOf("<IsDirect>")+"</IsDirect>".length()-1,parseXml.indexOf("</IsDirect>")):"";
                        columnName = valueArr[0] + ",Request_Type,CifId,CreditGrade,RelatedPartyId,wi_name";
                        columnValues = valueArr[1] + ",'" + returnType + "','" + cifId + "','" + CreditGrade + "','" + RelatedPartyId + "','" + wi_name + "'";
