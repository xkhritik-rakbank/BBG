...
public class iRBLFircoHoldIntegration
{
			...
			HashMap<String, String> socketDetailsMap, HashMap<String, String> ExtTabDataMap)
	{
		...
		try
		{
			...
			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Integration input XML: "+sInputXML);
			...
			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("responseXML: "+responseXML);
		    ...
		    iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Return Code: "+return_code);
		    ...
		    iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Return Desc: "+return_desc);
			...
			int connection_timeout, int integrationWaitTime,HashMap<String, String> socketDetailsMap, HashMap<String, String> ExtTabDataMap, StringBuilder sInputXML)
	{
		...
		try
		{
			...
			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("userName "+ username);
			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("SessionId "+ sessionId);
			...
			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("SocketServerPort "+ socketServerPort);
	   		...
	   		if (!("".equalsIgnoreCase(socketServerIP) && socketServerIP == null && socketServerPort==0))
	   		{
    			...
    			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Dout " + dout);
    			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Din " + din);
    			...
    			if (inputRequest != null && inputRequest.length() > 0)
    			{
    				...
    				iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("RequestLen: "+inputRequestLen + "");
    				inputRequest = inputRequestLen + "##8##;" + inputRequest;
    				iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("InputRequest"+"Input Request Bytes : "+ inputRequest.getBytes("UTF-16LE"));
    			...
    			if (num > 0)
    			{
    				...
    				iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("OutputResponse: "+outputResponse);
    		...
    		{
    			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("SocketServerIp and SocketServerPort is not maintained "+"");
    			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("SocketServerIp is not maintained "+	socketServerIP);
    			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug(" SocketServerPort is not maintained "+	socketServerPort);
		...
		{
			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Exception Occured Mq_connection_CC"+e.getStackTrace());
			return "";
		}
		finally
		{
			...
			{
				iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Final Exception Occured Mq_connection_CC"+e.getStackTrace());
				//printException(e);
			}
		}
			...
			String processInstanceID, String ws_name, String userName, StringBuilder sInputXML)
	{
		...
		strBuff.append("</MQ_REQUEST_XML>");
		strBuff.append("</APMQPUTGET_Input>");
		iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("GetRequestXML: "+ strBuff.toString());
			...
			sessionId, String processInstanceID,String message_ID, int integrationWaitTime)
	{
		...
		try
		{
			...
			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Response APSelect InputXML: "+responseInputXML);

			int Loop_count=0;
			do
			{
				String responseOutputXML=CommonMethods.WFNGExecute(responseInputXML,sJtsIp,iJtsPort,1);
				iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Response APSelect OutputXML: "+responseOutputXML);

			    XMLParser xmlParserSocketDetails= new XMLParser(responseOutputXML);
			    String responseMainCode = xmlParserSocketDetails.getValueOf("MainCode");
			    iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("ResponseMainCode: "+responseMainCode);



			    int responseTotalRecords = Integer.parseInt(xmlParserSocketDetails.getValueOf("TotalRetrieved"));
			    iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("ResponseTotalRecords: "+responseTotalRecords);
			    ...
			    if (responseMainCode.equals("0") && responseTotalRecords > 0)
				{
	        		...
	        		//iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("ResponseXMLData: "+responseXMLData);

	        		outputResponseXML=xmlParserResponseXMLData.getValueOf("OUTPUT_XML");
	        		//iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("OutputResponseXML: "+outputResponseXML);
		...
		{
			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Exception occurred in outputResponseXML" + e.getMessage());
			iRBLFircoHoldLog.iRBLFircoHoldLogger.debug("Exception occurred in outputResponseXML" + e.getStackTrace());
			outputResponseXML="Error";
		}
