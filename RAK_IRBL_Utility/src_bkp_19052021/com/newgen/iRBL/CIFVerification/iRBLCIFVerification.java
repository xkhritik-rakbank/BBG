...
public class iRBLCIFVerification implements Runnable
{
	...
	{
		final String ws_name="iRBL_CIF_Verification";
		...
		try
		{
			...
			iRBLCIFVerificationLog.iRBLCIFVerificationLogger.debug("Number of workitems retrieved on RAOP_Status_Update: "+fetchWorkitemListCount);
