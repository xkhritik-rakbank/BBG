...
Module					: RAOP Status
File Name				: AOApprovalHoldLog.java
...
public final class iRBLAOApprovalHoldLog
{
	private static String loggerName = "iRBLAOApprovalHoldLogger";
    protected static org.apache.log4j.Logger iRBLAOApprovalHoldLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "iRBL_AOApprovalHold_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/iRBL_AOApprovalHold_Logs/"+logDateFormat.format(date)+"/iRBL_AOApprovalHold_Log.xml";
