...
Module					: RAOP Status
File Name				: iRBLStatusUpdateLog.java
...
public final class iRBLStatusUpdateLog
{
	private static String loggerName = "iRBLStatusUpdateLogger";
    protected static org.apache.log4j.Logger iRBLStatusUpdateLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "iRBL_StatusUpdate_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/iRBL_StatusUpdate_Logs/"+logDateFormat.format(date)+"/iRBL_StatusUpdate_Log.xml";
