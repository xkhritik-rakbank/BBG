...
public final class iRBLCIFUpdateLog
{
	private static String loggerName = "iRBLCIFUpdateLogger";
    protected static org.apache.log4j.Logger iRBLCIFUpdateLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "iRBL_CIFUpdate_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/iRBL_CIFUpdate_Logs/"+logDateFormat.format(date)+"/iRBL_CIFUpdate_Log.xml";
