...
Module					: RAOP Status
File Name				: iRBLFinIntegrationationCIFUpdateLog.java
...
public final class iRBLFinIntegrationCIFUpdateLog
{
	private static String loggerName = "iRBLFinIntegrationCIFUpdateLogger";
    protected static org.apache.log4j.Logger iRBLFinIntegrationCIFUpdateLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "iRBL_FinIntegrationCIFUpdate_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/iRBL_FinIntegrationCIFUpdate_Logs/"+logDateFormat.format(date)+"/iRBL_FinIntegrationCIFUpdate_Log.xml";
