			 ...
			 iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", inside onclick function for attach Dedupe click");
				...
				try{
					...
					properties.load(new FileInputStream(System.getProperty("user.dir")+ System.getProperty("file.separator")+ "ConfigFiles" + System.getProperty("file.separator")+ "iRBL_SysCheckIntegration_Config.properties"));
						...
						preface.setAlignment(Element.ALIGN_JUSTIFIED);
			            doc.add(preface);*/
			        	if("C".equalsIgnoreCase(CompFlag) || MainCIFFlag) 
			        	{
					...
					/*	if("Y".equalsIgnoreCase(CompFlag) || "Yes".equalsIgnoreCase(CompFlag) || MainCIFFlag) 
			        	{
						...
						if("C".equalsIgnoreCase(CompFlag) || MainCIFFlag) 
			        	{
				           ...
				           //System.out.println("Prepared");
							...
							for (int j = 0; j < iRBLIntegration.DedupeGridCIFID.size(); j++) {
				                ...
				                c8 = new PdfPCell(new Phrase(iRBLIntegration.DedupeGridCIFStatus.get(j)));
								iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", Aftr CIFIDarray for WINAME "+WINAME+" : "+iRBLIntegration.DedupeGridCIFStatus.get(j));
								...
								c3 = new PdfPCell(new Phrase(iRBLIntegration.DedupeGridIncorporationDate.get(j)));
				                iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", dateOfIncorporation for WINAME "+WINAME+" : "+iRBLIntegration.DedupeGridIncorporationDate.get(j));
								c3.setBackgroundColor(new BaseColor(255,251,240));
								c3.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
				                pdf.addCell(c3);
								
								
								c4 = new PdfPCell(new Phrase(iRBLIntegration.DedupeGridIncorporationCountry.get(j)));
								//System.out.println("Aftr EmiratesIDarray");
								iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", \n CountryOfIncorporation value for WINAME "+WINAME+" : "+iRBLIntegration.DedupeGridIncorporationCountry.get(j));
								c4.setBackgroundColor(new BaseColor(255,251,240));
								c4.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
								pdf.addCell(c4);
								
								c5 = new PdfPCell(new Phrase(iRBLIntegration.DedupeGridIncorporationTLNo.get(j)));
				                //System.out.println("Aftr PassportNumberarray");
								iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", \n TL No value for WINAME "+WINAME+" : "+iRBLIntegration.DedupeGridIncorporationTLNo.get(j));
			...
			try
			{
	            ...
	            if("C".equalsIgnoreCase(CompFlag) || MainCIFFlag ) 
	            {
					...
					*/
					...
					try
					{
			            ...
			            iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", After PdfPTable append 5:");  
						pdf.addCell(c5);
						iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", After PdfPTable append 13:");  
			            pdf.addCell(c13);
						iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", After PdfPTable append 6:");  
			            pdf.addCell(c6);
			            /*iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", After PdfPTable append 7:");  
						...
						*/
						...
						iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", After PdfPTable append 9:");  
						pdf.addCell(c12);
						iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", After PdfPTable append 12"
								+ ":");  
						pdf.addCell(c15);
					...
					for (int j = 0; j < iRBLIntegration.BlacklistGridCIFID.size(); j++) {
						...
						c4 = new PdfPCell(new Phrase(iRBLIntegration.BlacklistGridDateOfIncorp.get(j)));
						//System.out.println("Aftr EmiratesIDarray");
						...
						c5 = new PdfPCell(new Phrase(iRBLIntegration.BlacklistGridCountryOfIncorp.get(j)));
		                //System.out.println("Aftr PassportNumberarray");
		                ...
		                c13 = new PdfPCell(new Phrase(iRBLIntegration.BlacklistGridTLNo.get(j)));
		                //System.out.println("aftr Phonearray");
		             ...
		             */
		                ...
		                c14 = new PdfPCell(new Phrase(iRBLIntegration.BlacklistGridBlacklistedDate.get(j)));
		                iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", \n BlackListFlagarray value for WINAME "+WINAME+" : "+iRBLIntegration.BlacklistGridBlacklistedFlag.get(j));
		                ...
		                c15 = new PdfPCell(new Phrase(iRBLIntegration.BlacklistGridNegatedDate.get(j)));
		                iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", \n NEGATED_FLAGarray value for WINAME "+WINAME+" : "+iRBLIntegration.BlacklistGridNegatedFlag.get(j));
				...
				*/	
					...
					for (int j = 0; j < iRBLIntegration.BlacklistGridCIFID.size(); j++) {
		                ...
		                c13 = new PdfPCell(new Phrase(iRBLIntegration.BlacklistGridDOB.get(j)));
		                //System.out.println("Aftr PassportNumberarray");
						iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("WINAME : "+WINAME+", WSNAME: "+ActivityName+", \n PassportNumberarray value for WINAME "+WINAME+" : "+iRBLIntegration.BlacklistGridPassportNo.get(j));
						c13.setBackgroundColor(new BaseColor(255,251,240));
						c13.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
		...
		else if(IntegrationCall.equals("COMPLIANCE_CHECK"))
		{
			...
			//PDF Generation****************************************
					try{
						...
						String ReqBusinessUnit = "WBASMEIRBL";						
