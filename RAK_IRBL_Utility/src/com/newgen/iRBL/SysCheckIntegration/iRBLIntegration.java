...
public class iRBLIntegration {
						...
						if (StatusType.equalsIgnoreCase("Black List"))
						{
							...
							if(MainBlacklistFlag.equalsIgnoreCase("Y"))
							{
								...
								while(rowData.contains("<StatusDetails>"))
								{
									...
									iRBLSysCheckIntegrationLog.iRBLSysCheckIntegrationLogger.debug("Creation Date:"+MainBlacklistDate);
									countwhilchk1++;
									if(countwhilchk1 == 50)
									{
										countwhilchk1 = 0;
			...
			HashMap<String, String> socketDetailsMap, HashMap<String, String> ExtTabDataMap, HashMap<String, String> RelPartyGridDataMap, boolean MainCIF_Flag)
	{
		try
		{
			...
			String RequestingUnitName = "WBASMEIRBL";  // it was changed from BUSINESSFINANCESME to WBASMEIRBL as per mail subject - "Firco changes indirect testing in SME loans and accounts" from sameera on 08112023
			StringBuilder sInputXML = new StringBuilder("<EE_EAI_MESSAGE>\n"+
								"<EE_EAI_HEADER>\n"+
