				...
				for(int i=0; i<fetchWorkitemListCount; i++)
				{
					...
					if(integrationStatus.contains("~"))
					{
						...
						if ("Exit".equalsIgnoreCase(tmp[1]))
						{
							...
							RemarksForDecHistory="This BAIS Workitem "+tmp[2]+" is Approved";
							String ActDateTime = tmp[0];
							iRBLAOApprovalHoldLog.iRBLAOApprovalHoldLogger.debug("Decision" +decisionValue+", ActDateTime- "+ActDateTime);
						...
						else if ("Reject".equalsIgnoreCase(tmp[1]))
						{
							...
							RemarksForDecHistory="This BAIS Workitem "+tmp[2]+" is Rejected";
