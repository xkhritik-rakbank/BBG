...
public final class iRBLCIFVerificationLog
{
	private static String loggerName = "iRBLCIFVerificationLogger";
    protected static org.apache.log4j.Logger iRBLCIFVerificationLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "iRBL_CIFVerification_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/iRBL_CIFVerification_Logs/"+logDateFormat.format(date)+"/iRBL_CIFVerification_Log.xml";
