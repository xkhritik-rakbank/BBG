...
public class iRBLBAISWICreateIntegration
{
	...
	public String IsAEDExpressFormAttached="";
	public String SalesInitiated="";
			...
			HashMap<String, String> socketDetailsMap, Map <String, String> BAISWICreateConfigParamMap)
	{
		...
		try
		{
			...
			String DBQuery = "select a.ITEMINDEX, a.WINAME, a.BPM_REF_BAIS, a.SOL_ID, a.TL_NUMBER, a.RAK_TRACK_NUMBER_BAIS, a.FINACLE_SR_NUMBER, "+
					...
					"a.DOMESTIC_CURR,a.CHANNELSOURCE,a.Compliance_Decision,a.FCYBlockText "+	
					"from  "+
					...
					"DOMESTIC_CURR,CHANNELSOURCE, "+
					"(select top 1 decision from USR_0_IRBL_WIHISTORY with(nolock) where WORKSTEP='Compliance_EDD' and WI_NAME='"+processInstanceID+"' order by ACTION_DATE_TIME desc) as Compliance_Decision, "+
					"(select CONST_FIELD_VALUE from USR_0_BPM_CONSTANTS with(nolock) where CONST_FIELD_NAME='BAIS_DefaultTextForDomesticCurrencyOnlyOrNoFCY') as FCYBlockText "+	
			...
			if(xmlParserData.getValueOf("MainCode").equalsIgnoreCase("0"))
			{
				...
				{		
					...
					if("RM Apply".equalsIgnoreCase(objWorkList.getVal("CHANNELSOURCE")))
					{
						SalesInitiated="Yes";
					}
					...
					if("S".equalsIgnoreCase(downloadAndAttachStatus))
					{
						...
						String attributeTag="CHANNEL"+fieldSep+"iRBL.WBA"+recordSep
							...
							+"EXPRESSCONSENT"+fieldSep+IsAEDExpressFormAttached+recordSep
							+"SALESAGENTINITIATED"+fieldSep+SalesInitiated+recordSep;
						...
						{
							attributeTag+="DomesticCurrencyOnlyOrNoFCY"+fieldSep+objWorkList.getVal("FCYBlockText")+recordSep;
						}
						else if("Yes".equalsIgnoreCase(objWorkList.getVal("DOMESTIC_CURR")))
						{
							attributeTag+="DomesticCurrencyOnlyOrNoFCY"+fieldSep+objWorkList.getVal("FCYBlockText")+recordSep;
						}
	...
	public String downloadAllDocsFromiRBLWI(HashMap<String, String> CheckGridDataMap, Map <String, String> BAISWICreateConfigParamMap)
	{
		...
		if (!docListXML.trim().equalsIgnoreCase("F"))
		{
			...
			for(int i=0;i<noOfDocs;i++)
			{
				...
				if("AED_Express_Form".equalsIgnoreCase(docName))
				{
					IsAEDExpressFormAttached="Yes";
				}
				else
				{
					IsAEDExpressFormAttached="No";
				}
	...
	public String getIRBLToBAISDocMapping(String iRBLDOCName)
	{
		...
		if(iRBLDOCName.contains("AECB_Consent_Form_Company"))
			...
			BAISDocName = "RBL_BVR_CAM_TWC_ABF_LAF_Photographs";
		else if(iRBLDOCName.contains("RBL_BVR_CAM_TWC_ABF_LAF Photographs") || iRBLDOCName.contains("ABF"))
			BAISDocName = "RBL_BVR_CAM_TWC_ABF_LAF_Photographs";
		...
		else if(iRBLDOCName.contains("Others") || iRBLDOCName.contains("ADMIN_DOCS") || iRBLDOCName.contains("OptionalDocs"))
		...
		else if(iRBLDOCName.contains("Additional account opening form") || iRBLDOCName.contains("Dormancy form"))
		...
		else if(iRBLDOCName.contains("Insurance") || iRBLDOCName.contains("WPS_Insurance"))
		...
		else if(iRBLDOCName.contains("Other Clearance Proof") || iRBLDOCName.contains("FIRCO Response"))
		...
		else if(iRBLDOCName.contains("Central Bank Blacklist Check"))
			BAISDocName = "OperationsDedupeForAsset";
		else if(iRBLDOCName.contains("Dedupe_ForCompany") || iRBLDOCName.contains("Dedupe_ForSignatories") || iRBLDOCName.contains("Blacklist_ForCompany") || iRBLDOCName.contains("Blacklist_ForSignatories") || iRBLDOCName.contains("Fircosoft_ForCompany") || iRBLDOCName.contains("Fircosoft_ForSignatories"))
			BAISDocName = "De-Dupe";		
		else if(iRBLDOCName.contains("Single_View"))
			BAISDocName = "Controls_Checklist";
