...
public final class iRBLBAISWICreateLog
{
	private static String loggerName = "iRBLBAISWICreateLogger";
    protected static org.apache.log4j.Logger iRBLBAISWICreateLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "iRBL_BAIS_WICreate_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/iRBL_BAIS_WICreate_Logs/"+logDateFormat.format(date)+"/iRBL_BAIS_WICreate_Log.xml";
