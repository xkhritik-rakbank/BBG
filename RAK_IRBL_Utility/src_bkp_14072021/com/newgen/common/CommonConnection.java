...
import com.newgen.iRBL.BAISWICreate.iRBLBAISWICreateIntegration;
...
public class CommonConnection
{
	...
	private static String checkOFExistingSession(Logger ConnectionLogger)
	{
		...
		//String getSessionQry="select top(1) RANDOMNUMBER from pdbconnection";
		String getSessionQry="select randomnumber from pdbconnection with(nolock) where userindex in (select userindex from pdbuser with(nolock) where username='"+sOFUserName+"')";
