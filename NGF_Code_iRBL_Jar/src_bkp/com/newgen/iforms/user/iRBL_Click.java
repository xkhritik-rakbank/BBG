...
public class iRBL_Click extends iRBL_Common {
	...
	{
		iRBL.mLogger.debug("WINAME : "+getWorkitemName()+", WSNAME: "+getActivityName()+", controlName "+controlName);
		...
		if(controlName.equals("PDFGenerate"))
            ...
            return new iRBL_Integration().onclickevent(iform, "btn_View_Signature",data);
	    else
	    	return "";	
	}
}
